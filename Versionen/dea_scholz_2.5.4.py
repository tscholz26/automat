...
deatristan = Menu(menubar, tearoff = 0)
...
deatristan.add_command(label = "q-Schreibweise", command = lambda:(exec("tristanq")))
deatristan.add_command(label = "S-Schreibweise", command = lambda:(exec(tristans)))
deamenu.add_cascade(label = "Regelmenge Tristan S", menu = deatristan)
